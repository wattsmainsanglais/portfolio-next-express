...
app.use(function (req, res, next) {
  ...
  const allowedOrigins = ['https://server-production-7c47.up.railway.app/api/express/contact', 'https://portfolio-next-express-production.up.railway.app', 'http://localhost:5000'];
