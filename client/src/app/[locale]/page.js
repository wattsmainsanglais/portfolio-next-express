...
import { FaFacebookSquare, FaInstagram, FaLinkedinIn, FaGithub, FaGoogle } from "react-icons/fa"
      ...
      <header className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href='https://www.malt.fr/profile/andrewwatts'
              target='_blank'
              rel="noopener noreferrer"
              className="text-slate-700 dark:text-white hover:text-brand-500 dark:hover:text-brand-400 transition-colors"
              aria-label="Malt"
            >
              <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width={38} height={38} fill="currentColor">
            ...
            <a
              href='https://share.google/PQF5jxwFMfsScMlvu'
              target='_blank'
              rel="noopener noreferrer"
              className="text-slate-700 dark:text-white hover:text-brand-500 dark:hover:text-brand-400 transition-colors"
