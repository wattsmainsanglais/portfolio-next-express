...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    keywords: [
      ...
      'création site web Civray', 'développeur web web Ruffec', 'création site web Vienne 86',
      'développeur web web Angoulême', 'développeur web web Limoges', 'développeur web web Poitiers',
