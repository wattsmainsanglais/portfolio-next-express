          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              <div className="space-y-2">
                <div className={`grid gap-2 ${vatApplicable ? 'grid-cols-12' : 'grid-cols-10'}`}>
                  ...
                  <div className="col-span-2 text-xs text-muted-foreground text-right">Qty</div>
                  <div className="col-span-2 text-xs text-muted-foreground text-right">Unit Price (€)</div>
                  {vatApplicable && <div className="col-span-2 text-xs text-muted-foreground text-right">VAT %</div>}
                  ...
                  <div key={i} className={`grid gap-2 items-center ${vatApplicable ? 'grid-cols-12' : 'grid-cols-10'}`}>
                    <div className="col-span-5">
                      <input
                        ...
                        className="w-full bg-muted text-foreground rounded-lg px-3 py-2 text-sm border border-input focus:outline-none focus:border-brand-500/60 focus:ring-1 focus:ring-brand-500/20 transition-colors placeholder:text-muted-foreground/50"
                      />
                    </div>
                    <div className="col-span-2">
                      <input
                        ...
                        required
                        className="w-full bg-muted text-foreground rounded-lg px-3 py-2 text-sm border border-input focus:outline-none focus:border-brand-500/60 focus:ring-1 focus:ring-brand-500/20 transition-colors text-right"
                      />
                    </div>
                    <div className="col-span-2">
                      <input
                    ...
                    {vatApplicable && (
                      <div className="col-span-2">
                        <select
                          ...
                          className="w-full bg-muted text-foreground rounded-lg px-3 py-2 text-sm border border-input focus:outline-none focus:border-brand-500/60 transition-colors"
                        >
                          {VAT_RATES.map((r) => (
            ...
            <div className="flex gap-3 pt-1">
              <button
                ...
                className="px-6 py-2.5 rounded-xl text-sm text-muted-foreground hover:text-foreground border border-border hover:border-foreground/30 transition-colors"
              >
                Cancel
              </button>
              <button
                type="submit"
                disabled={isPending}
                className="flex-1 bg-brand-600 hover:bg-brand-700 text-white rounded-xl py-2.5 text-sm font-medium disabled:opacity-50 transition-colors shadow-sm"
              >
